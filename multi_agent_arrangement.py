...
config_list = autogen.config_list_from_json(
    "OAI_CONFIG_LIST",
    filter_dict={
         "model": ["gpt-4-1106-preview", "gpt-4-1106", "gpt-4-0314","gpt-4","gpt-4-32k","gpt-3.5-turbo"],
...
Leader  = autogen.AssistantAgent(
    ...
    system_message = """
                     ...
                     You will receive the request from the client, which will be a breif desciption of the kind of music they want, and also the melody line in ABC notation.
                     ...
                     Some information will be revealed in the provided melody line in ABC notation, while some attributes can be seen in the client description.
                     ...
                     The final output should also include the melody provided by clients.
                     """,
...
MelodyAgent = autogen.AssistantAgent(
    ...
    system_message="""
                    ...
                    You will review a single-line melody based on the client's input and assigned tasks from the Leader.
                    You don't need to update the melody line. We want to keep the idea from the client.
                    You must output your work in ABC Notations, if any.
                    ...
                    ```
                    You will output the melody following this template, wrapping up the parameters but left the melody from client unchanged.
                    After you receive the feedback from the Reviewer Agent, you may improve your work according to the suggestions you were given.
                    """,
    llm_config=llm_config,
)
...
HarmonyAgent = autogen.AssistantAgent(
    ...
    system_message="""
                    ...
                    You will harmonize the melody composed by the client, please do not left any unharmonized melody.
...
InstrumentAgent = autogen.AssistantAgent(
    ...
    system_message="""
                   ...
                   You can choose common instruments like piano, guitar, strings, and so on. Or the instruments specified by clients.
                   ...
                   You can also add percussion or drum tracks, to upgrade music expressivity.
